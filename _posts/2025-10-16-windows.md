...
tags: Productivity
last_modified_at: 2026/05/06 19:11:26
...
PowerToys 설정: 
<img src="https://github.com/user-attachments/assets/e9795e67-4aae-465a-94b7-6978f318a016" width="30%">
...
- 관리 편의를 위해 가급적 프로그램은 **Windows Store** 활용
  ...
  - **Microsoft PowerToys** 다양한 설정, 특히 Keyboard Manager 키맵 변경 매우 유용
  - **카카오톡**
...
- Game Bar 비활성화. Powershell에서 `Get-AppxPackage Microsoft.XboxGamingOverlay | Remove-AppxPackage`

## 개발 도구
- **JetBrains Toolbox**
- [**Visual Studio Code**](/wiki/Visual-Studio-Code) 정리 참고
- **Docker Desktop** 윈도우에서 설치하면 WSL2에서도 docker가 설치된다. 따로 docker를 사용하진 않지만 빌드를 위해서 반드시 필요하다.
- **Cursor**
