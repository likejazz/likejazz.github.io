...
- 각종 도구와 컴파일러, 앱 등 모든 도구는 **Homebrew**를 통해 설치
  ...
  - 앱 스토어 관리를 위해 **mas** 설치: `$ brew install mas`
  - 쓰지 않는 Numbers, Pages, Keynote, iMovie, GarageBand 기본 앱 삭제: `$ mas uninstall 361304891 361309726 361285480 408981434 682658836`
- 기본 Terminal 사용하며 [**Zsh**](/wiki/Zsh) 설정, [**CLI Productivity**](/wiki/CLI-Productivity) 참고
  - 설정 > Profiles > Shell > Run command: `ssh box`
  - Text: 조금 더 크게
- 메인 브라우저는 **Chrome** 사용
- **카카오톡** `$ mas install 869223134`
...
- 문서 공유 시 **iCloud Drive**를 사용한다. 무엇보다 최신 앱들이 iCloud Drive 저장 기능을 제공한다. 하지만 문서 저장 용도와 Find My Mac을 제외한 다른 iCloud 기능은 사용하지 않는다.
- 사진 자료가 무료 용량을 초과하여 **Google One(유료)**을 구독한다.
- 오랫동안 **Google Drive**에 문서를 보관해왔으며, 최근에는 백업 파일도 함께 보관하고 있다.
