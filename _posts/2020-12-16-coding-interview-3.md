...
테스트 케이스 중에는 일부러 입력값에 수천, 수만 개를 입력해 두고 타임아웃을 유발하는 경우도 있습니다. 시간 복잡도가 $$O(n2)$$인 알고리즘은 타임아웃이 발생하고 $$O(n)$$ 또는 적어도 $$O(n\log{n})$$정도는 되어야 풀리는 상황을 만들어내기 위해서 입니다.
...
<img src="https://user-images.githubusercontent.com/1250095/102351238-76eb6400-3fe9-11eb-9f3d-2eeb1e09b1e5.png" width="40%">
