...
온라인 서점에서도 컴퓨터 분야 일간 판매 순위 1위를 기록하며 순항 중에 있습니다. 여전히 초급 실용서가 판매 순위 상위를 차지하는 국내 도서 시장에서는 매우 고무적인 일입니다. 무엇보다 《파이썬 알고리즘 인터뷰》로 인해 우리나라에 기본기가 튼튼한 좋은 개발자가 더 늘어날 수 있다면 그것으로 소임을 다한 것에 여한이 없습니다. 나아가 이 책이 여러분의 커리어에 좋은 길잡이가 될 수 있다면 그것으로 더 이상 여한이 없습니다.
