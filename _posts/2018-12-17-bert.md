...
title: BERT 톺아보기
tags: ["NLP"]
last_modified_at: 2024/02/12 12:06:33
---
...
<p>본 내용을 바탕으로 한글 모델의 성능을 실험하기 위해 <a href="http://korquad.github.io">KorQuAD</a>에 참여하여 state-of-the-art를 달성하는 좋은 성과를 거두었습니다. <strong>EM, F1 모두 1위를 기록</strong>함은 물론, Human Performance를 능가하는 첫 번째 모델을 제출하였고, 회사 홍보팀의 제안을 받아 홍보팀의 도움으로 다음과 같이 보도자료를 배포하였습니다.</p>
