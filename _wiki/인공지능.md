...
layout: wiki 
title: 인공지능
last-modified: 2020/11/26 20:00:37
---

<!-- TOC -->

- [역사](#역사)
- [탐색 <sup>Search</sup>](#탐색-search)
...
- [생성 시스템 <sup>Production System</sup>](#생성-시스템-production-system)
    ...
    - [응용분야](#응용분야)
- [전문가 시스템 <sup>Expert System</sup>](#전문가-시스템-expert-system)
    - [How Expert Systems Work](#how-expert-systems-work)
        - [지식 베이스 <sup>The Knowledge Base</sup>](#지식-베이스-the-knowledge-base)
        - [추론 기관 <sup>The Inference Engine</sup>](#추론-기관-the-inference-engine)
