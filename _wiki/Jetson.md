...
title: Jetson
tags: ["MLOps & HPC"]
last_modified_at: 2024/04/17 17:47:14
---
...
- [도구](#도구)
	...
	- [ollama](#ollama)
- [성능](#성능)
- [NVIDIA 제공 LLM 성능](#nvidia-제공-llm-성능)
...
처음에는 l4t-pytorch로 docker 환경을 구성했다. 공식 NGC에 최신 버전이 없고 직원 개인 페이지에서 관리되고 있다. L4T는 Linux for Tegra이며 이를 이용해 [#1 Docker](https://github.com/likejazz/links)을 수정해 [#3 Docker](https://github.com/likejazz/links)으로 설정했다.
...
# 성능
[#5 GPU comparison: Jetson Orin, RTX 4080 SUPER](https://github.com/likejazz/links)
