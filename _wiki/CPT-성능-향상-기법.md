...
title: CPT 성능 향상 기법
tags: ["LLM Training"]
last_modified_at: 2024/10/24 19:47:08
---
...
instruct에 cpt를 진행했다. 이 경우 굳이 결과를 보지 않아도 당연히 aligned가 망가질거라 예상할 수 있다. cpt이후 instruct 모델로 실험한 결과와 비교가 있으면 좋았을텐데, intruct를 재현할 수 없다.
