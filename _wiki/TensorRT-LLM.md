...
last_modified_at: 2024/02/14 00:47:03
---
...
## Dockerfile
[설치 스크립트](https://github.com/NVIDIA/TensorRT-LLM/blob/main/docker/Dockerfile.multi)를 제공하므로 참고하여 docker에서 빌드해본다. 기존에 [사용하던 dockerfile #1](https://github.com/likejazz/private-links) 참고.
```bash
#!/bin/bash
