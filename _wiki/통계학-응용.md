...
layout: wiki 
title: 통계학 응용
last-modified: 2020/11/30 17:57:58
---
...
- [이론 및 사례](#이론-및-사례)
    ...
    - [벤포드의 법칙 <sup>Benford's law</sup>](#벤포드의-법칙-benfords-law)
- [F1 Score](#f1-score)
...
**무한 원숭이 정리<sup>Infinite monkey theorem</sup>** 는 무한성에 기초한 원리로,타자기 앞에 앉아서 마음대로 쳐대는 원숭이가 프랑스 국립 박물관의 모든 책을 언젠가는 쳐 낼 가능성이 거의 확실<sup>Almost surely, Probability 1</sup>하다는 정리이다. 즉, $$\lim_{x\rightarrow\infty}{P(x)}=1$$ 이다.
...
> 실세계에 존재하는 많은 수치 데이터의 10진법 값 수의 첫째 자리의 확률 분포를 관찰한 결과, 첫째 자리 숫자가 작을 확률이 크다는 법칙이다. (위키피디어)
