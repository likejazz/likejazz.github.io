...
last-modified: 2020/06/19 19:26:43
---
...
Tom Mitchel의 Machine Learning 책이 연상된다. 수식만 제시하지만 실제로 예제값을 이용해 계산도 진행한다. 여기서는 예제 데이터셋으로 수박 세트를 계속해서 활용하는데 그래서 중국어 판에는 표지가 수박 그림이다. 교과서라도 이런식으로 예제값을 이용해 직접 계산하는 책은 직관적이고 이해가 쉽다.
