...
last-modified: 2020/11/20 15:10:13
---
...
★★★★☆  
이론을 충실히 소개하는 텍스트북의 형태를 띄면서도 캐글러 수준의 실용성을 가미한 매우 좋은 책이다. 번역이 다소 아쉽지만 판매량을 볼때 이런 책이 한글로 출간된 것 자체에 감사해야 할 것 같다. 물론 번역이 좋았다면 좀 더 나을 수 있을 것 같다. 별점이 하나 빠진 것은 온전히 번역 때문이다.
